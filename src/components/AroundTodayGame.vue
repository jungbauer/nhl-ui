<script setup>
  ...
  function goToGame() {
    ...
    if (props.game.gameState !== "FUT") {
      router.push(`/game_${props.game.nhlGameId}`);
    }
  }
</script>
      ...
      >
        <div class="game-grid">
          ...
          <div class="team-grid">
            ...
            <div class="team-name" :class="{'team-name-xs': xs}">{{ game.homeTeam.commonName }}</div>
          </div>
          <div class="versus">
            <div>VS</div>
            <div v-if="game.gameState !== 'FUT' && game.gameOutcome !== 'REG'">
              ({{ game.gameOutcome }})
            </div>
          </div>
          <div class="team-grid">
            ...
            <div class="team-name" :class="{'team-name-xs': xs}">{{ game.awayTeam.commonName }}</div>
          </div>
        </div>
      </v-sheet>
    </template>
